...
**The finding (full run, 1,814 of 1,824 buildings screened → 1,154 campuses):**

> **500 campuses — 43% — are DISPUTED**: physically viable land now inside an active local
> moratorium's blast radius. 541 clear a first-pass screen; 113 are flagged. The top of the
...
(1,824 OSM buildings roll up to 1,154 campuses — operator + 4 km clustering — because a
single campus is tagged as many rooftops; the campus number is the honest one.)
